...
enum StoreKitProductID: String, CaseIterable {
    case monthly = "com.appfactory.dialdeck.subscription.monthly"
    case yearly = "com.appfactory.dialdeck.subscription.yearly"
    case lifetime = "com.appfactory.dialdeck.subscription.lifetime"
        ...
        for await result in Transaction.currentEntitlements {
            do {
                ...
                case .autoRenewable, .nonRenewable:
                    if transaction.revocationDate == nil { purchasedSubs.insert(transaction.productID) }
                case .nonConsumable:
                    if transaction.revocationDate == nil { purchasedNonCons.insert(transaction.productID) }
                default: break
                }
            } catch {
